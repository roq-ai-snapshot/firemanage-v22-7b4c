...
import { getEmergencyResponsePlanById } from 'apiSdk/emergency-response-plans';
...
function EmergencyResponsePlanViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Emergency Response Plan Detail View
          </Text>
          {hasAccess('emergency_response_plan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/emergency-response-plans/edit/${data?.id}`} passHref legacyBehavior>
              <Button
